...
class MealService {
  static const String _tokenKey = 'auth_token'; // Use the same token key as other services
  ...
  Future<List<Meal>> getAllMeals({int? userId}) async {
    final uri = Uri.parse('${AppConfig.apiUrl}/nutrition/meals${userId != null ? "?userId=$userId" : ""}');
